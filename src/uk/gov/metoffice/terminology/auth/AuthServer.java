...
package uk.gov.metoffice.terminology.auth;
 ...
 */
 public abstract class AuthServer {
	 ...
	 * The all URI {@link uk.gov.metoffice.terminology.auth.AuthConfig#allURI} can be used to specify generic authorizations (e.g.: agent-action-all).
