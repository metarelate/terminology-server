...
public class WebCommand extends TsCommand {
	...
	@Override
	public void localExecute() throws ConfigurationException {
	    ...
	    server.addConnector(connector);
			...
			*/
	        ...
	        String warFile=myInitializer.getWARFile();
	        Loggers.webAdminLogger.debug("WAR file : "+warFile);
	        bb.setWar(warFile);
	      //bb.setServer(server);
	...
	public static String getStaticLocalHelpMessage() {
		return "ts web [--port number]\n"+
				"Starts a web server for local admin on the port specified (defaults to "+CoreConfig.DEFAULT_ADMIN_PORT+")\n"+
